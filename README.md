...
> **สถานะ:** Phase 0 เสร็จ · **Phase 1 เสร็จ ขึ้นเซิร์ฟเวอร์แล้ว** · **Phase 2 กำลังทำ (2.1 เสร็จ)**
> เทสต์ผ่าน **51/51** กับ Postgres จริง · Lighthouse `/login` 100 · `/booking` 91
>
> 👉 **มารับงานต่อ อ่าน [`docs/03-PHASE-ROADMAP.md`](docs/03-PHASE-ROADMAP.md) ก่อน** —
> งานถัดไปคือ **2.2 แนบรูปถ่าย** ทำได้เลยไม่ต้องรอลูกค้า
...
| แนบรูปถ่าย · ลายเซ็น | ❌ Phase 2.2 / 2.3 — **งานถัดไป** |
| Export PDF ภาษาไทย | ❌ Phase 2.4 — รอโลโก้เวกเตอร์จากลูกค้า |
| แอปช่างบนมือถือ | 🟡 เห็นงานตัวเอง ยังกรอกใบงานไม่ได้ (Phase 2.5) |
...
| `tests/catalog.pricing.test.ts` | 9 | ✅ | ราคาที่ลูกค้ายืนยันแล้วต้องไม่เพี้ยน |
| `tests/forms.validator.test.ts` | 15 | ❌ | ฟอร์มที่กรอกถูกต้องต้องส่งผ่าน |
...
**51 เทสต์ ผ่านทั้งหมด** ส่วนใหญ่รันกับ PostgreSQL จริง ไม่ใช่ mock
