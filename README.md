...
> **2.4 Export PDF** (ปลดล็อกแล้ว ได้โลโก้ความละเอียดสูงจากลูกค้า) · **2.6 แจ้งเตือน LINE** (มีสเปคแล้ว ดู [`docs/06-SPEC-LINE-NOTIFY.md`](docs/06-SPEC-LINE-NOTIFY.md) · รอลูกค้าเปิด Messaging API)
...
| Export PDF ภาษาไทย | ❌ Phase 2.4 — **ทำได้แล้ว** ได้โลโก้ 2000×1185 จากลูกค้าเมื่อ 19 ส.ค. 2569 |
